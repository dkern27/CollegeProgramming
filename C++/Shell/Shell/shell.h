...
private: //HELPER FUNCTIONS
    std::string pathExists(std::string path);
    
    int executeSingleCommand(std::vector<std::string>& tokens);
    
    char** getExternalCommandArgs(std::vector<std::string> &args);
    
    void getExternalCommands(std::vector<std::string> &matches, std::string input="");
    
    int executePipedCommands(std::vector<std::string> args);
    
    int runCommand(int, int, char**);
    
    std::vector<std::vector<std::string> > makeCommands(std::vector<std::string>, int);
    
    bool validInput(std::vector<std::string> tokens);
    
    void checkBinForCommands(std::vector<std::string> &tokens);
};
